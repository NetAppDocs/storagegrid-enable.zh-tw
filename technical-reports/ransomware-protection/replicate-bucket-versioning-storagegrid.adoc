...
+
image:ransomware-protection-create-endpoint.png["勒索軟體保護 - cree-Endpoint"]
...
+
image:ransomware-protection-create-ilm-rule.png["勒索軟體保護 - cree-ILM 規則"]

+
image:ransomware-protection-create-ilm-rule-step-2.png["勒索軟體保護 - cree-ilm 規則 - 步驟 2"]

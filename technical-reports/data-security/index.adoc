...
這是 NetApp ® StorageGRID ® 中許多安全功能的總覽、涵蓋資料存取、物件和中繼資料、管理存取權和平台安全性。此更新已更新為包含 StorageGRID 11.8 所發佈的最新功能。
...
本白皮書概述 StorageGRID 11.8 中的許多安全功能、分為五大類：
...
* StorageGRID 11.8 文件頁面 https://docs.netapp.com/us-en/storagegrid-118/[]
